        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Auxion, build based on LISK
            </h1>
            <p className="py-5 leading-normal text-gray-500 text-md lg:text-xl xl:text-2xl dark:text-gray-300">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              >
                <BlockExplorerLogo />
                <div>View on Blockexplorer</div>
              </Link>
              <Link
                href="https://github.com/ghozzza/"
                target="_blank"
                rel="noopener"
                className="flex items-center space-x-2 gap-1 px-8 py-4 text-sm xl:text-lg font-medium text-center text-gray-500 dark:text-gray-400 rounded-md"
              >
                <GithubLogo />
                <p className="ml-4">
                View on Github
