    ...
    <Container className="flex flex-wrap ">
      <div className="flex items-center w-full lg:w-1/2">
        <div className="max-w-2xl mb-8">
          ...
          Auxion is a revolutionary platform for blockchain-based auctions, built on the robust and scalable Lisk network. 
          It offers an innovative and decentralized solution for secure, transparent, and efficient auctions, empowering users to trade assets with confidence.
          </p>
