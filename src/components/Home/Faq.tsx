...
const faqdata = [
  {
    ...
    answer: "Auxion is a decentralized auction platform built on the Lisk network, providing secure, transparent, and efficient auction solutions powered by blockchain technology.",
  },
  {
    question: "How does Auxion ensure transparency in auctions?",
    answer: "All transactions and bids on Auxion are recorded on the blockchain, creating an immutable and transparent ledger that prevents fraud and ensures trust.",
  },
  {
